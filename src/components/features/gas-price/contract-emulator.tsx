...
export default function ContractInteraction() {
  ...
  >({});
  const [estimatingFunctions, setEstimatingFunctions] = useState<
      ...
      <div className="space-y-6">
        ...
        {isLoading && (
          <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-blue-700 text-sm">Processing ABI...</p>
          </div>
        )}
          ...
          <div className="mt-6">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-md font-semibold">
                Callable Functions ({callableFunctions.length})
              </h3>
            ...
            <div className="space-y-4 max-h-96 overflow-y-auto">
              {callableFunctions
                ...
                .map((func, index) => {
                  ...
                  const isFuncEstimating =
                    estimatingFunctions[func.name] || false;

                  const updateFuncParam = (
                    paramIndex: number,
                    value: string
                  ) => {
                                ...
                                {func.inputs.map((input, idx) => (
                                  <div key={idx}>
                                    ...
                                    <input
                                      ...
                                      onChange={(e) =>
                                        updateFuncParam(idx, e.target.value)
                                      }
